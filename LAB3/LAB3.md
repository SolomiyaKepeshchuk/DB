...
<p align="center">
  ...
  <i>Рисунок 12 – Видалення послуги “Додаткова екскурсія”</i>
</p>
...
<p align="center">
  ...
  <i>Рисунок 13 – Список гідів після видалення Прокопенко Юлії</i>
</p>
...
<p align="center">
  ...
  <i>Рисунок 14 – Список турів після видалення туру “Осінній тур до Праги”</i>
</p>

---

## Висновок
Під час виконання лабораторної роботи я перевіряла роботу бази даних туристичної агенції за допомогою різних SQL-запитів. Виконувала вибірку даних, додавала нові записи, оновлювала та видаляла їх. Щоб переконатися в правильності виконаних операцій, після кожної з них я запускала перевірочні запити. У результаті вдалося краще розібратися з командами `SELECT`, `INSERT`, `UPDATE`, `DELETE`, а також із використанням умови `WHERE`.
