...
Очікуваний результат: у таблиці буде оновлено номер телефону клієнта.
```sql
...
Очікуваний результат: у таблиці буде оновлено вартість туру та його місткість.
...
Очікуваний результат: у таблиці буде оновлено вартість додаткової послуги.
