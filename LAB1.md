...
## 2. Діаграма ER.
<p align="center">
  <img src="DB_ER_LAB1.png" width="900"><br>
...
- booking_service_id (PK): унікальний ідентифікатор запису про послугу в бронюванні.
...
- tour_guide_id (PK): унікальний ідентифікатор запису про призначення гіда на тур.
...
- Booking — Payment (1:1): кожне бронювання має одну оплату.
...
## 6. Висновок
Ось той самий текст, але без згадки про наступні роботи:

---

## Висновок
У процесі виконання лабораторної роботи було здійснено збір та аналіз вимог до інформаційної системи, визначено основні сутності, їх атрибути та взаємозв’язки між ними. На основі отриманих вимог побудовано концептуальну ER-діаграму, яка відображає структуру даних майбутньої бази даних. Виконана робота дозволила краще зрозуміти принципи моделювання даних та логіку побудови структури бази даних.
