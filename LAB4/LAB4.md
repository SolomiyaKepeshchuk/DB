...
## Висновок
Під час виконання лабораторної роботи було розроблено аналітичні SQL-запити для бази даних туристичної агенції. У роботі були використані агрегатні функції COUNT, SUM, AVG, MIN, MAX, а також оператори GROUP BY і HAVING для групування та фільтрації даних. Також було виконано запити з різними типами JOIN, щоб об’єднати дані з кількох таблиць, і запити з підзапитами. У результаті я краще зрозуміла, як за допомогою SQL можна не тільки переглядати дані, а й аналізувати їх та отримувати підсумкову інформацію з бази даних.
